...
\begin{itemize}
    ...
    \item \textit{Seating Module}: quản lý đặt bàn và tình trạng bàn.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{image/gantt-chart.png}
    \caption{Gantt Chart mô tả timeline phát triển hệ thống}
    \label{fig:work-assignment-style}
\end{figure}
